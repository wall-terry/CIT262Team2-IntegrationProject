...
public class JMessagingFrame extends JFrame {
    ...
    private JMenuItem menuItemCserver    = new JMenuItem("Connect to Server");
    private JMenuItem menuItemStartServer    = new JMenuItem("Start Server");
    ...
    private void buildButtonActionListeners() {
        ...
        rSendButton.addActionListener(
                ...
                try {
                    ...
                    System.out.println();
                    //                        try {
                    //                            url = new URL("http", "127.0.0.1", 8080, "stuff", null);
                    ...
                    Logger.getLogger(JMessagingFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private JMenuBar buildMenu() {
        ...
        connect.add(menuItemCserver);
        connect.add(menuItemStartServer);
    ...
    private void buildMenuActionListeners() {
        ...
        // Add menu item action listener for connect menu.
        menuItemCserver.addActionListener(
          new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
              // Call inner class help handler.
                  Object[] IpValues = { "127.0.0.1", "localhost", "choose my own ip" };
                  ipaddress = JOptionPane.showInputDialog(null,
                              "Choose one", "Input",
                              JOptionPane.INFORMATION_MESSAGE, null,
                              IpValues, IpValues[0]);
                  if (ipaddress == "choose my own ip"){
                          ipaddress = JOptionPane.showInputDialog("Connect to what IP?\n127.0.0.1 format");
                  }
                  Object[] PortValues = { "80", "8080", "choose different port" };
                          port = JOptionPane.showInputDialog(null,
                              "Choose one", "Input",
                              JOptionPane.INFORMATION_MESSAGE, null,
                              PortValues, PortValues[0]);
                  if (port == "choose my own port"){
                          port = JOptionPane.showInputDialog("Connect to what Port?");
                  }
        ...
        // Add menu item action listener for connect menu.
        menuItemStartServer.addActionListener(
          new ActionListener()
          {
            public void actionPerformed(ActionEvent e)
            {
...
//              }
//
//              server.createContext("/test", new JMessengerHttpHandler());
